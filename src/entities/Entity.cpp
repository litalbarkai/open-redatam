...
Entity::Entity()
    : m_name(""), m_parentName(""), m_description(""), m_indexFilename(""),
      m_child(nullptr), m_variables(), m_bounds({0, 0}), m_reader(),
      m_rowsCount(0) {}
...
Entity::Entity(const string &name, const string &parentName,
    ...
    : m_name(name), m_parentName(parentName), m_description(description),
      m_indexFilename(idxFileName), m_child(nullptr), m_variables(),
      m_bounds(bounds), m_reader(idxFileName), m_rowsCount(0) {
